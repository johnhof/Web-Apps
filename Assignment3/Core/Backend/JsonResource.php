...
function gameJson ($array, $msg) {
  ...
  $array['content'] = '<input type="button" id="new" name="new" class="false_button" value="Try a new word" onclick="newGame()"/></br>'
                      ...
                      .'<table id="game_table" class="game_table">'
                        .'<tr id="r0">'
                          .'<td class="turn_marker" id="c0-1"></td>'
                        ...
                        .'</tr>'
                        .'<tr id="r1">'
                          .'<td class="turn_marker" id="c1-1"></td>'
                        ...
                        .'</tr>'
                        .'<tr id="r2">'
                          .'<td class="turn_marker" id="c2-1"></td>'
                        ...
                        .'</tr>'
                        .'<tr id="r3">'
                          .'<td class="turn_marker" id="c3-1"></td>'
                        ...
                        .'</tr>'
                        .'<tr id="r4">'
                          .'<td class="turn_marker" id="c4-1"></td>'
